...
<div class="row">
    ...
    <section class="col-lg-8">
                ...
                @foreach($group as $cart_key=>$cartItem)
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div
                                            class=" text-accent text-success">{{ \App\CPU\Helpers::currency_converter($cartItem['price']-$cartItem['discount']) }}</div>
                                ...
                                <td>
                                    <button class="btn btn-link py-0 my-0 text-danger"
        ...
        <div class="row pt-2">
            ...
            <div class="col-6">
                <a onclick="checkout()"
                   class="btn btn-success text-white pull-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}">
